                                ...
                                <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                                    ...
                                    <div class="border bg-light p-3 rounded mb-3">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <label class="form-label" for="f1">Solo trip</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                                            <label class="form-label" for="f2">Couple trip</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                                            <label class="form-label" for="f3">Friends trip</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                                            <label class="form-label" for="f4">Family trip</label>
                                        </div>
                                    </div>
                                    <div class="border bg-light p-3 rounded mb-3">
                        ...
                        <div class="card mb-4 border-0 shadow">
                            <div class="row g-0 p-3 align-items-center">
                                ...
                                <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                                    ...
                                    <a href="#" class="btn btn-success btn-sm w-100 text-white custom-bg shadow-none mb-2">Book Now</a>
